(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Navigo = factory(root.Navigo);
  }
}(this, function(Navigo) {
    ...
    return routes
      .map(route => {
        var {
          regexp,
          paramNames
        } = replaceDynamicURLParts(clean(route.route));
  ...
  Navigo.prototype = {
    ...
    resolve: function(current) {
      ...
      GETParameters.split("&").map(e => e.split("=")).forEach(e => GETParametersObj[e[0]] = e[1]);
      GETParameters = GETParametersObj;
